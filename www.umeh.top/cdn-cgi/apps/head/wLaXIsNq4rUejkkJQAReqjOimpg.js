...
CloudflareApps.siteId = "f894b8a82adb0d06a97085828dcff7ce";
...
CloudflareApps.installs["063ultFzXoQr"] = {
    appId: "Ek_0U0d0YWhZ",
    scope: {}
};;
CloudflareApps.installs["063ultFzXoQr"].options = {};;
CloudflareApps.installs["1uSXhO5ANA5G"] = {
    appId: "ftSYTOLuWZbg",
    scope: {}
};;
CloudflareApps.installs["1uSXhO5ANA5G"].options = {
    "acceptButton": "OK",
    "opacity": 70,
    "policyText": "By using this website, you agree that we and our partners may set cookies for experience improvement."
};;
CloudflareApps.installs["1uSXhO5ANA5G"].URLPatterns = ["^www.umeh.top/?$"];;
CloudflareApps.installs["io5cHhV5ZnlT"] = {
    appId: "yOqKXAyfqbFq",
    scope: {}
};;
CloudflareApps.installs["io5cHhV5ZnlT"].options = {
    "advancedOptions": {
        "autoDisplay": true,
        "multilanguagePage": true
    },
    "advancedOptionsToggle": true,
    "colors": {
        "background": "#efefef",
        "foreground": "#fafafa",
        "text": "#444444"
    ...
    "specificLanguagesToggle": true
};;
CloudflareApps.installs["io5cHhV5ZnlT"].URLPatterns = ["^www.umeh.top/reviews/?.*$"];;
CloudflareApps.installs["io5cHhV5ZnlT"].selectors = {
    "element.selector": "#panel_instructors"
};;
CloudflareApps.installs["m0hsYGaaRiv5"] = {
    appId: "0VJ1mCYqPTh4",
    scope: {}
};;
CloudflareApps.installs["m0hsYGaaRiv5"].options = {
    "color": {
        "custom": "#666666",
        "strategy": "automatic"
    },
...
if (CloudflareApps.matchPage(CloudflareApps.installs['063ultFzXoQr'].URLPatterns)) {
    (function(modules) {
...
if (CloudflareApps.matchPage(CloudflareApps.installs['io5cHhV5ZnlT'].URLPatterns)) {
    (function(modules) {
        var installedModules = {};
        ...
        (function() {
            ...
            function updateStylesheet() {
                var _options = options,
                    _options$colors = _options.colors,
                    background = _options$colors.background,
                    foreground = _options$colors.foreground,
                    text = _options$colors.text
            ...
            window[CALLBACK_NAME] = function updateElement() {
                var _options2 = options,
                    pageLanguage = _options2.pageLanguage
                ...
                if (options.specificLanguagesToggle) {
                    var _options3 = options,
                        specificLanguages = _options3.specificLanguages
                ...
                if (options.advancedOptionsToggle) {
                    var _options4 = options,
                        advancedOptions = _options4.advancedOptions
            ...
            window.CloudflareApps.installs['io5cHhV5ZnlT'].scope = {
...
(function() {
    ...
    script.src = '/cdn-cgi/apps/body/N6V05FoQDgG30m98KHhxcoueMa0.js';
    document.head.appendChild(script);
})();